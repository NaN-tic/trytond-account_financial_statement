...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:trytonspain/trytond-account_financial_statement',
    ...
    project_urls = {
       "Source Code": 'https://github.com:trytonspain/trytond-account_financial_statement'
    },
    classifiers=[
